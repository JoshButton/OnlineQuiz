var questions = [
	...
	{ prompt: "The IEEE 80{ prompt: "3 Standard defines _________ CSMA/CD as the access method for firstgeneration 10-Mbps Ethernet.
	\n(A) 1-persistent
	\n(B) p-persistent
	\n(C) non-persistent
	\n(D) none of the above", 
	...
	{ prompt: "Each station on an Ethernet network has a unique _______ address imprinted on its network interface card (NI\n(C).
	\n(A) 5-byte
	\n(B) 32-bit
	\n(C) 48-bit
	\n(D) none of the above",  
